...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\AppSopayController' => 'getAppSopayControllerService',
            'App\\Services\\Sopay' => 'getSopayService',
            ...
            'csa_guzzle.client.sms_api' => 'getCsaGuzzle_Client_SmsApiService',
            'csa_guzzle.client.sopay_api' => 'getCsaGuzzle_Client_SopayApiService',
    ...
    /**
     * Gets the public 'App\Controller\AppSopayController' shared autowired service.
     *
     * @return \App\Controller\AppSopayController
     */
    protected function getAppSopayControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/AppSopayController.php';

        $this->services['App\\Controller\\AppSopayController'] = $instance = new \App\Controller\AppSopayController(($this->services['App\\Services\\Sopay'] ?? $this->getSopayService()));
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'session' => '?',
            'twig' => '?',
        ]))->withContext('App\\Controller\\AppSopayController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Services\Sopay' shared autowired service.
     *
     * @return \App\Services\Sopay
     */
    protected function getSopayService()
    {
        include_once \dirname(__DIR__, 4).'/src/Services/Sopay.php';

        return $this->services['App\\Services\\Sopay'] = new \App\Services\Sopay(($this->services['csa_guzzle.client.sopay_api'] ?? $this->getCsaGuzzle_Client_SopayApiService()));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CCn-hu+1Zg', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('006CtM2sdn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getCsaGuzzle_Client_DefaultService()
    {
        ...
        $a->push(($this->privates['csa_guzzle.middleware.stopwatch'] ?? $this->getCsaGuzzle_Middleware_StopwatchService()), 'stopwatch');
        $a->push(($this->privates['csa_guzzle.middleware.history'] ?? $this->getCsaGuzzle_Middleware_HistoryService()), 'history');

        return $this->services['csa_guzzle.client.default'] = new \GuzzleHttp\Client(['handler' => $a]);
    }

    /**
     * Gets the public 'csa_guzzle.client.sms_api' shared service.
     *
     * @return \GuzzleHttp\Client
     */
    protected function getCsaGuzzle_Client_SmsApiService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/guzzlehttp/guzzle/src/ClientInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/guzzlehttp/guzzle/src/Client.php';
        include_once \dirname(__DIR__, 4).'/vendor/guzzlehttp/guzzle/src/HandlerStack.php';
        ...
        return $this->services['csa_guzzle.client.sms_api'] = new \GuzzleHttp\Client(['base_uri' => 'https://sms.xpiment.com', 'headers' => ['X-Callback-Url' => 'https://app.soleaspay.com', 'Content-Type' => 'application/json'], 'on_stats' => [0 => ($this->services['csa_guzzle.data_collector.history_bag'] ?? ($this->services['csa_guzzle.data_collector.history_bag'] = new \Csa\GuzzleHttp\Middleware\History\History())), 1 => 'addStats'], 'handler' => $a]);
    }

    /**
     * Gets the public 'csa_guzzle.client.sopay_api' shared service.
     *
     * @return \GuzzleHttp\Client
     */
    protected function getCsaGuzzle_Client_SopayApiService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/guzzlehttp/guzzle/src/ClientInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/guzzlehttp/guzzle/src/Client.php';
        include_once \dirname(__DIR__, 4).'/vendor/guzzlehttp/guzzle/src/HandlerStack.php';
        ...
        return $this->services['csa_guzzle.client.sopay_api'] = new \GuzzleHttp\Client(['base_uri' => 'http://localhost', 'headers' => ['callback' => 'https://app.soleaspay.com', 'Content-Type' => 'application/json'], 'on_stats' => [0 => ($this->services['csa_guzzle.data_collector.history_bag'] ?? ($this->services['csa_guzzle.data_collector.history_bag'] = new \Csa\GuzzleHttp\Middleware\History\History())), 1 => 'addStats'], 'handler' => $a]);
    }
    ...
    /**
     * Gets the public 'sms' shared autowired service.
     *
     * @return \App\Services\Sms
     */
    protected function getSmsService()
    {
        include_once \dirname(__DIR__, 4).'/src/Services/Sms.php';

        return $this->services['sms'] = new \App\Services\Sms(($this->services['csa_guzzle.client.sms_api'] ?? $this->getCsaGuzzle_Client_SmsApiService()));
    }
    ...
    /**
     * Gets the private '.service_locator.jOm4G_B' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_JOm4GBService()
    {
        return $this->privates['.service_locator.jOm4G_B'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AppSopayController::contact' => ['privates', '.service_locator.8ZuNAXa', 'get_ServiceLocator_8ZuNAXaService', false],
            'App\\Controller\\AppSopayController:contact' => ['privates', '.service_locator.8ZuNAXa', 'get_ServiceLocator_8ZuNAXaService', false],
        ], [
            'App\\Controller\\AppSopayController::contact' => '?',
            'App\\Controller\\AppSopayController:contact' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yhp3GNEdsZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ByOwGgHa8Q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qoZ1PbeD8M', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QuI6FOLwO3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tNHat9H-DY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pQam9EXPPe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getCsaGuzzle_Middleware_HistoryService()
    {
        ...
        return $this->privates['csa_guzzle.middleware.history'] = new \Csa\GuzzleHttp\Middleware\History\HistoryMiddleware(($this->services['csa_guzzle.data_collector.history_bag'] ?? ($this->services['csa_guzzle.data_collector.history_bag'] = new \Csa\GuzzleHttp\Middleware\History\History())));
    }
    ...
    protected function getCsaGuzzle_Middleware_StopwatchService()
    {
        ...
        return $this->privates['csa_guzzle.middleware.stopwatch'] = new \Csa\GuzzleHttp\Middleware\Stopwatch\StopwatchMiddleware(($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.jOm4G_B'] ?? $this->get_ServiceLocator_JOm4GBService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
